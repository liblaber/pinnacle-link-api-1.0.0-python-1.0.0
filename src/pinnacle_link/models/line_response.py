...
@JsonMap(
    {
        ...
        "team1_red_cards": "team1RedCards",
        "team2_red_cards": "team2RedCards",
        ...
        "period_team1_score": "periodTeam1Score",
        "period_team2_score": "periodTeam2Score",
        "period_team1_red_cards": "periodTeam1RedCards",
        "period_team2_red_cards": "periodTeam2RedCards",
    }
)
class LineResponse(BaseModel):
    ...
    def __init__(
        self,
        status: LineResponseStatus = None,
        price: float = None,
        line_id: int = None,
        alt_line_id: int = None,
        team1_score: int = None,
        team2_score: int = None,
        team1_red_cards: int = None,
        team2_red_cards: int = None,
        ...
        period_team1_score: int = None,
        period_team2_score: int = None,
        period_team1_red_cards: int = None,
        period_team2_red_cards: int = None,
    ):
        if status is not None:
            self.status = self._enum_matching(
                status, LineResponseStatus.list(), "status"
            )
