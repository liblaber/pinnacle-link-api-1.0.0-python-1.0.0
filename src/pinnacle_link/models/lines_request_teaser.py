...
class LinesRequestTeaserOddsFormat(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, LinesRequestTeaserOddsFormat._member_map_.values())
        )
...
class LinesRequestTeaser(BaseModel):
    ...
    def __init__(
        self,
        teaser_id: int,
        odds_format: LinesRequestTeaserOddsFormat,
        legs: List[TeaserLineRequest],
    ):
        self.teaser_id = teaser_id
        self.odds_format = self._enum_matching(
            odds_format, LinesRequestTeaserOddsFormat.list(), "odds_format"
        )
