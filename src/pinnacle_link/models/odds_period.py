...
@JsonMap(
    {
        ...
        "max_moneyline": "maxMoneyline",
        "max_total": "maxTotal",
        "max_team_total": "maxTeamTotal",
        "moneyline_updated_at": "moneylineUpdatedAt",
        "spread_updated_at": "spreadUpdatedAt",
        "total_updated_at": "totalUpdatedAt",
        "team_total_updated_at": "teamTotalUpdatedAt",
...
class OddsPeriod(BaseModel):
    ...
    :param status: 1 - online, period is open for betting  2 - offline, period is not open for betting , defaults to None
    ...
    def __init__(
        ...
        max_moneyline: float = None,
        max_total: float = None,
        max_team_total: float = None,
        moneyline_updated_at: str = None,
        spread_updated_at: str = None,
        total_updated_at: str = None,
        team_total_updated_at: str = None,
        spreads: List[OddsSpread] = None,
        moneyline: OddsMoneyline = None,
        totals: List[OddsTotal] = None,
        team_total: OddsTeamTotals = None,
