...
@JsonMap(
    {
        ...
        "moneyline_description": "moneylineDescription",
        "total_description": "totalDescription",
        "team1_total_description": "team1TotalDescription",
        "team2_total_description": "team2TotalDescription",
        "spread_short_description": "spreadShortDescription",
        "moneyline_short_description": "moneylineShortDescription",
        "total_short_description": "totalShortDescription",
        "team1_total_short_description": "team1TotalShortDescription",
        "team2_total_short_description": "team2TotalShortDescription",
    }
)
class SportPeriod(BaseModel):
    ...
    def __init__(
        ...
        moneyline_description: str = None,
        total_description: str = None,
        team1_total_description: str = None,
        team2_total_description: str = None,
        spread_short_description: str = None,
        moneyline_short_description: str = None,
        total_short_description: str = None,
        team1_total_short_description: str = None,
        team2_total_short_description: str = None,
    ):
