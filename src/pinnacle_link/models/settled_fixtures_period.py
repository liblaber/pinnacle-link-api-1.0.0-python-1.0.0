...
class SettledFixturesPeriodStatus(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, SettledFixturesPeriodStatus._member_map_.values())
        )
...
@JsonMap(
    {
        ...
        "team1_score_sets": "team1ScoreSets",
        "team2_score_sets": "team2ScoreSets",
...
class SettledFixturesPeriod(BaseModel):
    ...
    :param status: Period settlement status.  1 = Event period is settled,  2 = Event period is re-settled,  3 = Event period is cancelled,  4 = Event period is re-settled as cancelled,  5 = Event is deleted , defaults to None
    ...
    def __init__(
        self,
        number: int = None,
        status: SettledFixturesPeriodStatus = None,
        settlement_id: int = None,
        settled_at: str = None,
        team1_score: int = None,
        team2_score: int = None,
        team1_score_sets: int = None,
        team2_score_sets: int = None,
        cancellation_reason: CancellationReasonType = None,
    ):
        if number is not None:
            self.number = number
        if status is not None:
            self.status = self._enum_matching(
                status, SettledFixturesPeriodStatus.list(), "status"
            )
