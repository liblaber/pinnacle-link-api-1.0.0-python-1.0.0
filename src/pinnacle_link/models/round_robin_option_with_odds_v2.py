...
class RoundRobinOptionWithOddsV2(BaseModel):
    ...
    def __init__(
        ...
        round_robin_option: RoundRobinOption,
        odds: float,
        unrounded_decimal_odds: float,
        number_of_bets: float = None,
    ):
