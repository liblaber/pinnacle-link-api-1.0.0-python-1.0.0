...
class TeaserLineRequestBetType(Enum):
    ...
    def list():
        ...
        """
        return list(
            map(lambda x: x.value, TeaserLineRequestBetType._member_map_.values())
        )
...
class TeaserLineRequest(BaseModel):
    ...
    def __init__(
        ...
        event_id: int,
        period_number: int,
        bet_type: TeaserLineRequestBetType,
        handicap: float,
        team: TeaserLineRequestTeam = None,
        side: TeaserLineRequestSide = None,
    ):
        self.leg_id = leg_id
        self.event_id = event_id
        self.period_number = period_number
        self.bet_type = self._enum_matching(
            bet_type, TeaserLineRequestBetType.list(), "bet_type"
        )
        if team is not None:
