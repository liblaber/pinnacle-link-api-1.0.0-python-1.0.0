...
@JsonMap(
    {
        ...
        "allow_round_robins": "allowRoundRobins",
        "league_specials_count": "leagueSpecialsCount",
        "event_specials_count": "eventSpecialsCount",
...
class League(BaseModel):
    ...
    def __init__(
        ...
        id_: int = None,
        name: str = None,
        home_team_type: str = None,
        has_offerings: bool = None,
        container: str = None,
        allow_round_robins: bool = None,
        league_specials_count: int = None,
        event_specials_count: int = None,
