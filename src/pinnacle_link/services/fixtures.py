...
class FixturesService(BaseService):
    ...
    def fixtures_v1_get(
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/fixtures", self.get_default_headers())
    ...
    def fixtures_special_v1_get(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/v1/fixtures/special", self.get_default_headers()
            )
            .add_query("sportId", sport_id)
            .add_query("leagueIds", league_ids)
            .add_query("since", since)
    ...
    @cast_models
    def fixtures_settled_v1_get(
        self, sport_id: int, league_ids: List[int] = None, since: int = None
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/v1/fixtures/settled", self.get_default_headers()
            )
            .add_query("sportId", sport_id)
            .add_query("leagueIds", league_ids)
            .add_query("since", since)
    ...
    @cast_models
    def fixtures_specials_settled_v1_get(
        self, sport_id: int, league_ids: List[int] = None, since: int = None
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/v1/fixtures/special/settled",
