...
class OddsService(BaseService):
    ...
    @cast_models
    def odds_straight_v1_get(
        self,
        sport_id: int,
        league_ids: List[int] = None,
        odds_format: OddsStraightV1GetOddsFormat = None,
        since: int = None,
        is_live: bool = None,
        event_ids: List[int] = None,
        to_currency_code: str = None,
    ) -> OddsResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/odds", self.get_default_headers())
            .add_query("sportId", sport_id)
            .add_query("leagueIds", league_ids)
            .add_query("oddsFormat", odds_format)
            .add_query("since", since)
            .add_query("isLive", is_live)
            .add_query("eventIds", event_ids)
            .add_query("toCurrencyCode", to_currency_code)
            .serialize()
            .set_method("GET")
        )
    ...
    def odds_teasers_v1_get(self, teaser_id: int) -> TeaserOddsResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/odds/teaser", self.get_default_headers())
            .add_query("teaserId", teaser_id)
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def odds_special_v1_get(
        self,
        sport_id: int,
        odds_format: OddsSpecialV1GetOddsFormat = None,
        league_ids: List[int] = None,
        since: int = None,
        special_id: int = None,
    ) -> SpecialOddsResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/odds/special", self.get_default_headers())
            .add_query("oddsFormat", odds_format)
            .add_query("sportId", sport_id)
            .add_query("leagueIds", league_ids)
            .add_query("since", since)
