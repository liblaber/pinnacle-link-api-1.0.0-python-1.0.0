...
class OthersService(BaseService):
    ...
    def sports_v2_get(self) -> SportsResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v2/sports", self.get_default_headers())
            .serialize()
            .set_method("GET")
        )
    ...
    def leagues_v2_get(self, sport_id: str) -> Leagues:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v2/leagues", self.get_default_headers())
    ...
    def periods_v1_get(self, sport_id: str) -> SportPeriod:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/periods", self.get_default_headers())
            .add_query("sportId", sport_id)
            .serialize()
            .set_method("GET")
        )
    ...
    def in_running_v1_get(self) -> InRunningResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/inrunning", self.get_default_headers())
            .serialize()
            .set_method("GET")
        )
    ...
    @cast_models
    def teaser_groups_v1_get(
        self, odds_format: TeaserGroupsV1GetOddsFormat
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/teaser/groups", self.get_default_headers())
    ...
    def cancellation_reasons_v1_get(self) -> CancellationReasonResponse:
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url}/v1/cancellationreasons", self.get_default_headers()
            )
            .serialize()
            .set_method("GET")
        )
    ...
    def currencies_v2_get(self) -> SuccessfulCurrenciesResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v2/currencies", self.get_default_headers())
            .serialize()
            .set_method("GET")
        )
