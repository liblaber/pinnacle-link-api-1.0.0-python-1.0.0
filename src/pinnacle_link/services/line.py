...
class LineService(BaseService):
    ...
    @cast_models
    def line_straight_v1_get(
        self,
        league_id: int,
        handicap: float,
        odds_format: LineStraightV1GetOddsFormat,
        sport_id: int,
        event_id: int,
        period_number: int,
        bet_type: LineStraightV1GetBetType,
        team: LineStraightV1GetTeam = None,
        side: LineStraightV1GetSide = None,
    ) -> LineResponse:
        """Returns latest line.
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/line", self.get_default_headers())
            .add_query("leagueId", league_id)
            .add_query("handicap", handicap)
            .add_query("oddsFormat", odds_format)
            .add_query("sportId", sport_id)
            .add_query("eventId", event_id)
            .add_query("periodNumber", period_number)
            .add_query("betType", bet_type)
            .add_query("team", team)
            .add_query("side", side)
            .serialize()
            .set_method("GET")
    ...
    @cast_models
    def line_parlay_v2_post(
        self, request_body: ParlayLinesRequest
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v2/line/parlay", self.get_default_headers())
            .serialize()
            .set_method("POST")
    ...
    @cast_models
    def line_teaser_v1_post(
        self, request_body: LinesRequestTeaser
    ) -> TeaserLinesResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/line/teaser", self.get_default_headers())
            .serialize()
            .set_method("POST")
            .set_body(request_body)
        )
    ...
    @cast_models
    def line_special_v1_get(
        self,
        odds_format: LineSpecialV1GetOddsFormat,
        special_id: int,
        contestant_id: int,
        handicap: int = None,
    ) -> SpecialLineResponse:
        ...
        serialized_request = (
            Serializer(f"{self.base_url}/v1/line/special", self.get_default_headers())
            .add_query("oddsFormat", odds_format)
            .add_query("specialId", special_id)
            .add_query("contestantId", contestant_id)
            .add_query("handicap", handicap)
            .serialize()
            .set_method("GET")
        )
